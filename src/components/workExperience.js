function WorkExperience () {
  ...
  return (
  <div className="scroll-auto flex flex-col items-center justify-center h-280">
          ...
          <div className = "border-b text-base">
            ...
            <ul className ="text-small">
              ...
              <div className ="w-75 text-base">
                ...
                <p className ="text-small"> November 2022- August 2023  </p>
                <p className ="text-small">February 2022 -September 2022 </p>   
                <p className ="mb-2 mt-2 font-bold">Responsibilities </p>
